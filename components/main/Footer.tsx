            ...
            <ul className="flex  gap-4">
              <li className="bg-dark/50 w-fit group text-light transition-colors cursor-pointer duration-300 button-primary relative rounded-full flex justify-center items-center p-2">
                <Link
                  ...
                  target="_blank"
                >
                  <IconBrandLinkedin className="object-cover group-hover:text-violet-600 w-6 h-6 transition-all duration-300 text-white" />
                </Link>
              </li>
              <li className="bg-dark/50 w-fit group text-light transition-colors cursor-pointer duration-300 button-primary relative rounded-full flex justify-center items-center p-2">
                <Link href="https://github.com/mhaddaou" target="_blank">
                  <IconBrandGithub className="object-cover group-hover:text-violet-600 w-6 h-6 transition-all duration-300 text-white" />
                </Link>
              </li>
              <li className="bg-dark/50 w-fit group text-light transition-colors cursor-pointer duration-300 button-primary   relative rounded-full flex justify-center items-center p-2">
                <Link
                  ...
                  target="_blank"
                >
                  <IconBrandHackerrank className="object-cover w-6 h-6 transition-all  duration-300 group-hover:text-violet-600 text-white" />
                </Link>
              </li>
            </ul>
          </div>
